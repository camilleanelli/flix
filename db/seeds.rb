User.create(name: "camille", username: "cam", password: "password", email: "cam@example.com", admin: true)

["Harry", "Ron", "Hermione", "Draco", "Voldemort"].each do |name|
...
Review.create([
  {comment: "Moyen", stars: 5, user: User.first, movie: Movie.last},
  {comment: "c'était gore", user: User.second, stars: 7, movie: Movie.last}
])
